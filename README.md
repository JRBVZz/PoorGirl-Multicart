...
#### Firmware
В архиве **PoorGirl-Firmware/PoorGirl-Firmware.zip** находятся проекты для Quartus. Все мапперы не влезут в EPM570T100 (тем более в EPM240T100), поэтому выберите нужные в начале файла с verolog кодом **Cool2Poor.v**, чтобы они поместились в 570 (240) логических ячеек.  
...
Оптимизированные прошивки можно найти на [форуме Emu-Land.net](https://www.emu-land.net/forum/index.php/topic,82545.0.html), но нужно будет изменить назначения выводов в **Pin Planner**.
